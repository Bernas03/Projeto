            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  TextButton(
                    /*TextButton que navega para a pagina de recuperar password*/
                    onPressed: () {
                      Get.toNamed('/recuperar');
                    },
                    child: Text(
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        setState(() {
                          /*Este botão captura os valores dos textfields usando os controllers e compara com os valores existentes na BD*/
                          /*Envia o Cuidador logado para a SharedPreferences e avança para a pagina principal*/
                          _emailLogin = _controllerEmailLogin.text;
                          _passwordLogin = _controllerPasswordLogin.text;
                        });
                        try {
                          int idAtual = -1;
                          for (int id = 1;; id++) {
                            ...
                            try {
                              Cuidador cuidador =
                                  await apiService.fetchCuidador(id);
                              if (cuidador.email == _emailLogin &&
                                  cuidador.password == _passwordLogin) {
                                idAtual = cuidador.id;
                                break;
                              }
                            } catch (e) {
                          ...
                          if (idAtual != -1) {
                            //print('Cuidador encontrado com ID: $idAtual');
                            SharedPreferences prefs =
                                await SharedPreferences.getInstance();
                            await prefs.setInt("id_cuidador_logado", idAtual);
                            Get.toNamed('/main');
                          } else {
                            print(
                                'Cuidador não encontrado com as credenciais fornecidas.');
                            mostrarSnackbar(context, 'Credenciais inválidas.');
                          }
                        } catch (e) {
